...
flowers = (flowers_100,flowers_25,flowers_5)
park = (park_1,park_5,park_10)
gauss = (gauss_1,gauss_5,gauss_10)

pickle.dump((x_all, y_all, flowers, park, gauss), open('solutions/mutation.p','wb'))