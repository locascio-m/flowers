...
# Layouts
fig3 = plt.figure(figsize=(14,7.5))
...
for i in scales:
    # Read FLOWERS data
    file_name = 'solutions/flowers_4_scale_' + str(i) + '.p'
...
ax0.semilogx(scales, aep_flowers, 'o')
ax1.semilogx(scales, time_flowers, 'o')
ax2.semilogx(scales, iter_flowers, 'o')
...
ax0.set(xlabel="Scaling", ylabel="AEP (GWh)")
ax0.grid(True)
ax1.set(xlabel="Scaling", ylabel="Time (hr)", ylim=0)
ax1.grid(True)
ax2.set(xlabel="Scaling", ylabel="Iterations", ylim=0)
ax2.grid(True)

ax40.grid(True)
ax40.legend(scales_str)
ax40.set(title='FLOWERS')
ax41.grid(True)
ax41.set(title='FLORIS')
fig3.tight_layout()
