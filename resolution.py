...
f = np.fft.rfft(freq)
f0 = np.fft.irfft(f, n=360)
f1 = np.fft.irfft(f[:100], n=360)
f2 = np.fft.irfft(f[:25], n=360)
f3 = np.fft.irfft(f[:10], n=360)
f4 = np.fft.irfft(f[:6], n=360)
# f0[-1] = f0[0]
# f1[-1] = f1[0]
# f2[-1] = f2[0]
# f3[-1] = f3[0]
...
ax.plot(np.linspace(0, 2*np.pi, 360), f0)
ax.plot(np.linspace(0, 2*np.pi, 360),f1)
ax.plot(np.linspace(0, 2*np.pi, 360),f2)
ax.plot(np.linspace(0, 2*np.pi, 360), f3)
ax.plot(np.linspace(0, 2*np.pi, 360), f4)
