...
file_base = 'solutions/opt_' + farm + '_flowers_parameter_' + str(k)[-2:] + '_'
...
solution = opt.run_optimization(optimizer="flowers", solver="SNOPT", gradient="analytical", timer=86400, history=history_file, output=output_file)
